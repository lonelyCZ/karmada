...
import (
	...
	"github.com/karmada-io/karmada/cmd/mcs-controller/app/options"
...
func NewMCSCommand(ctx context.Context) *cobra.Command {
	...
	cmd := &cobra.Command{
		Use:  "mcs-controller",
		Long: `The mcs-controller manages multi-cluster service discovery in a unified manner`,
	...
	cmd.AddCommand(sharedcommand.NewCmdVersion("mcs-controller"))
