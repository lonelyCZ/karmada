...
func selectBestClustersByCluster(spreadConstraint policyv1alpha1.SpreadConstraint, groupClustersInfo *GroupClustersInfo,
	...
	sort.Slice(groupClustersInfo.Clusters, func(i, j int) bool {
		return groupClustersInfo.Clusters[i].propagatePriority > groupClustersInfo.Clusters[j].propagatePriority
	})

	klog.Info(groupClustersInfo.Clusters)
